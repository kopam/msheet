    ...
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c16 = function(val) { 
          if (/^[0-9]+/.test(val))
            ...
            var colArr = _.filter(val, function(i){
              return /^[A-Z]/.test(i.toUpperCase());
            });
            var col = colArr[0].charCodeAt(0) - 63;
            for (var i = 1; i < colArr.length; i++){
              var c = colArr[i];
              col += (c.charCodeAt(0) - 63);
            };
            var row = parseInt(_.filter(val, function(i){
              return !/^[A-Z]/.test(i.toUpperCase());
            }).join('')) + 1;
